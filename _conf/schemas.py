...
_schemas = [
    Schema('friend',
           ...
           description_template=open('_conf/templates/friend.rst', 'r').read(),
    ...
    Schema('book',
           ...
           description_template=open('_conf/templates/book.rst', 'r').read(),
           reference_template='《{{ title }}》',
           missing_reference_template='《{{ title }}》',
           ambiguous_reference_template='《{{ title }}》'),
    Schema('artwork',
           ...
           description_template=open('_conf/templates/artwork.rst', 'r').read(),
    ...
    Schema('artist',
           ...
           description_template=open('_conf/templates/artist.rst', 'r').read(),
           reference_template='🧑‍🎨{{ title }}',
           missing_reference_template='🧑‍🎨{{ title }}',
           ambiguous_reference_template='🧑‍🎨{{ title }}'),
    Schema('gallery',
           name=F(uniq=True, ref=True, required=True, form=F.Forms.LINES),
           attrs={'website': F()},
           description_template=open('_conf/templates/gallery.rst', 'r').read(),
    ...
    Schema('event',
           ...
           description_template=open('_conf/templates/event.rst', 'r').read(),
           reference_template='📅{{ title }}',
           missing_reference_template='📅{{ title }}',
           ambiguous_reference_template='📅{{ title }}'),
    Schema('leetcode',
           ...
           description_template=open('_conf/templates/leetcode.rst', 'r').read(),
           reference_template='🧮{{ title }}',
           missing_reference_template='🧮{{ title }}',
           ambiguous_reference_template='🧮{{ title }}'),
    Schema('term',
           ...
           description_template=open('_conf/templates/term.rst', 'r').read(),
    ...
    Schema('jour',
           ...
           description_template=open('_conf/templates/jour.rst', 'r').read(),
           reference_template='📰{{ title }}',
           missing_reference_template='📰{{ title }}',
           ambiguous_reference_template='📰{{ title }}'),
    Schema('okr',
           ...
           description_template=open('_conf/templates/okr.rst', 'r').read(),
           reference_template='🎯{{ title }}',
           missing_reference_template='🎯{{ title }}',
           ambiguous_reference_template='🎯{{ title }}'),
Schema('people',
       ...
       description_template=open('_conf/templates/people.rst', 'r').read(),
       reference_template='👤{{ title }}'),
Schema('rhythm',
       name=F(ref=True),
       attrs={
       ...
       content=F(form=F.Forms.LINES),
       description_template=open('_conf/templates/rhythm.rst', 'r').read(),
       reference_template='🥁{{ title }}'),
Schema('dev',
       name=F(ref=True, required=True),
       attrs={
       ...
       description_template=open('_conf/templates/dev.rst', 'r').read(),
       reference_template='🎛️{{ title }}'),
Schema('loveletter',
       name=F(ref=True, required=True),
       attrs={
       ...
       description_template=open('_conf/templates/loveletter.rst', 'r').read(),
       reference_template='💌{{ title }}',
       missing_reference_template='💌{{ title }}',
       ambiguous_reference_template='💌{{ title }}'),
]
