...
standard_page = ['about.html',  'globaltoc.html', 'searchbox.html']
wide_page = standard_page + ['wide.html']
...
html_sidebars = {
    ...
    # Artworks gallery
    'notes/zxsys/way-to-artist/find-yourself': wide_page,
    'notes/zxsys/way-to-artist/find-topic': wide_page,
    'notes/zxsys/indoor-sketching': wide_page,
    'notes/zxsys/outdoor-sketching': wide_page,
}
